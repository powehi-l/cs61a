...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    tempcity = make_city('_', lat, lon)
    dis1, dis2 = distance(tempcity, city1), distance(tempcity, city2)
    if dis1 <= dis2:
...
#
def make_city(name, lat, lon): return [lon, [lat], name]
def get_name(city): return city[2]
def get_lat(city): return city[1][0]
def get_lon(city): return city[0]
