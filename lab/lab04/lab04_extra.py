...
def check_win_row(board, max_rows, max_cols, num_connect, row, player):
    ...
    for i in range(max_cols):
        whole += get_piece(board, row, i)
    return player*num_connect in whole
...
def check_win(board, max_rows, max_cols, num_connect, row, col, player):
    ...
    diagonal_win = check_win_diagonal(board, max_rows, max_cols, num_connect,
                                      row, col, player)
    row_win = check_win_row(board, max_rows, max_cols,
                            num_connect, row, player)
    col_win = check_win_column(
        board, max_rows, max_cols, num_connect, col, player)
    return any([diagonal_win, row_win, col_win])
